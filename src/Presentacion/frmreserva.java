...
public class frmreserva extends javax.swing.JInternalFrame {
     ...
     public void calcularDias(JDateChooser fechainicio, JDateChooser fechafinal){
       ...
       if(fechainicio.getDate()!=null&&fechafinal.getDate()!=null){
           ...
           try{
                ...
                ps.setString(1,txtnhabitacion.getText() );
                rs = ps.executeQuery(); 
                if(rs.next()){
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                    ...
                                    .addGap(18, 18, 18)
                                    .addComponent(txtnhabitacion, javax.swing.GroupLayout.PREFERRED_SIZE, 159, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btncancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncancelarActionPerformed
        ...
        txtcliente.setText("");
        txtcosto_alojamiento.setText("");
        dcfecha_ingresa.setCalendar(null);
    ...
    private void tablalistadoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablalistadoMouseClicked
        ...
        txtnhabitacion.setText(tablalistado.getValueAt(fila, 2).toString());
