...
CREATE TABLE dbo.Paises  
   (
   PaisesID int PRIMARY KEY NOT NULL,  
   PaisesName varchar(25) NOT NULL  
  )  
 

CREATE TABLE dbo.Provincias  
   (
   ProvinciasID int PRIMARY KEY NOT NULL,  
   ProvinciasName varchar(100) NOT NULL,  
   PaisesID int not NULL)  

   --INGRESO DE LOS PAISES------------
INSERT dbo.Paises (PaisesID, PaisesName )  
VALUES 
(1, 'Australia'),
(2, 'Austria'),
(3, 'Azerbaiyán'),
...
INSERT dbo.Provincias (ProvinciasID,PaisesID, ProvinciasName ) 
values 
(1, 3, 'Azerbaijan'),
